...
class Lookback extends Core
{
    ...
    public static function adxLookback(int $optInTimePeriod): int
    {
        ...
        return (2 * $optInTimePeriod) + (static::$unstablePeriod[FuncUnstId::ADX->value]) - 1;
    }
    ...
    public static function atrLookback(int $optInTimePeriod): int
    {
        ...
        return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::ATR->value]);
    }
    ...
    public static function cmoLookback(int $optInTimePeriod): int
    {
        ...
        $retValue = $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::CMO->value]);
    ...
    public static function dxLookback(int $optInTimePeriod): int
    {
        ...
        return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::DX->value]);
    }
    ...
    public static function emaLookback(int $optInTimePeriod): int
    {
        ...
        return $optInTimePeriod - 1 + (static::$unstablePeriod[FuncUnstId::EMA->value]);
    }
    ...
    {
        return 32 + (static::$unstablePeriod[FuncUnstId::HT_DCPERIOD->value]);
    }

    public static function htDcPhaseLookback(): int
    {
        return 63 + (static::$unstablePeriod[FuncUnstId::HT_DCPHASE->value]);
    }

    public static function htPhasorLookback(): int
    {
        return 32 + (static::$unstablePeriod[FuncUnstId::HT_PHASOR->value]);
    }

    public static function htSineLookback(): int
    {
        return 63 + (static::$unstablePeriod[FuncUnstId::HT_SINE->value]);
    }

    public static function htTrendlineLookback(): int
    {
        return 63 + (static::$unstablePeriod[FuncUnstId::HT_TRENDLINE->value]);
    }

    public static function htTrendModeLookback(): int
    {
        return 63 + (static::$unstablePeriod[FuncUnstId::HT_TRENDMODE->value]);
    }
    ...
    public static function kamaLookback(int $optInTimePeriod): int
    {
        ...
        return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::KAMA->value]);
    }
    ...
    public static function mamaLookback(float $optInFastLimit, float $optInSlowLimit): int
    {
        ...
        return 32 + (static::$unstablePeriod[FuncUnstId::MAMA->value]);
    }
    ...
    public static function mfiLookback(int $optInTimePeriod): int
    {
        ...
        return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::MFI->value]);
    }
    ...
    public static function minusDILookback(int $optInTimePeriod): int
    {
        ...
        if ($optInTimePeriod > 1) {
            return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::MINUS_DI->value]);
        }
    ...
    public static function minusDMLookback(int $optInTimePeriod): int
    {
        ...
        if ($optInTimePeriod > 1) {
            return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::MINUS_DM->value]) - 1;
        }
    ...
    public static function natrLookback(int $optInTimePeriod): int
    {
        ...
        return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::NATR->value]);
    }
    ...
    public static function plusDILookback(int $optInTimePeriod): int
    {
        ...
        if ($optInTimePeriod > 1) {
            return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::PLUS_DI->value]);
        }
    ...
    public static function plusDMLookback(int $optInTimePeriod): int
    {
        ...
        if ($optInTimePeriod > 1) {
            return $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::PLUS_DM->value]) - 1;
        }
    ...
    public static function rsiLookback(int $optInTimePeriod): int
    {
        ...
        $retValue = $optInTimePeriod + (static::$unstablePeriod[FuncUnstId::RSI->value]);
        if ((static::$compatibility) === Compatibility::Metastock->value) {
            $retValue--;
        }
    ...
    public static function t3Lookback(int $optInTimePeriod, float $optInVFactor): int
    {
        ...
        return 6 * ($optInTimePeriod - 1) + (static::$unstablePeriod[FuncUnstId::T3->value]);
    }
